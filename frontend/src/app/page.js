...
async function getHomePage() {
  ...
  try {
    ...
    const query = '/pages?filters[slug][$eq]=home&populate[content][on][sections.hero][populate]=*&populate[content][on][sections.feature-grid][populate][cards][populate]=*&populate[content][on][sections.cta][populate]=*&populate[content][on][sections.logo-cloud][populate][logos][populate]=*&populate[content][on][sections.project-network][populate][projects][populate]=*&populate[content][on][sections.news-feed][populate]=*&populate[content][on][sections.embed]=true';
